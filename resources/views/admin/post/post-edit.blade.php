    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                <!-- Title -->
                <h1 class="text-white">Edit a Course</h1>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 mx-auto text-center">
                <!-- Content -->
                <p class="text-center">Use this interface to update Course to the portal. Once you are done adding the item it will be reviewed for quality. If approved, your course will appear for sale and you will be informed by email that your course has been accepted.</p>
            </div>
        </div>
                            ...
                            <div id="step-1" role="tabpanel" class="content fade" aria-labelledby="steppertrigger1">
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input class="form-control" name="title" type="text" placeholder="Enter Post title" value="{{ $post->title }}">
                                    </div>
