            ...
            <div class="d-flex align-items-center d-xl-none">
                <a class="navbar-brand" href="index-2.html">
                    <img
                        ...
                        src="{{ asset('assets/images/logo-mobile.svg') }}"
                        alt="" />
                    <img
                        class="dark-mode-item navbar-brand-item h-30px"
                        src="{{ asset('assets/images/logo-mobile-light.svg') }}"
                        alt="" />
                </a>
            </div>
            <!-- Logo END -->
                ...
                <ul class="navbar-nav flex-row align-items-center">
                            ...
                            <div class="card bg-transparent">
                                <div
                                    ...
                                    <h6 class="m-0">
                                        Notifications
                                        <span
                                            class="badge bg-danger bg-opacity-10 text-danger ms-2">2 new</span>
                                    </h6>
                    ...
                    <li class="nav-item ms-2 ms-md-3 dropdown">
                        ...
                        <ul
                            ...
                            <li>
                                <a class="dropdown-item bg-danger-soft-hover" href="#"><i class="bi bi-power fa-fw me-2"></i>Sign Out</a>
                            </li>
                            <li>
                                <hr class="dropdown-divider" />
                            </li>
