        ...
        <div class="col-md-6 col-xxl-3">
            <div class="card card-body bg-warning bg-opacity-15 p-4 h-100">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <!-- Icon -->
                    <div
                        class="icon-lg rounded-circle bg-warning text-white mb-0">
        ...
        <div class="col-md-6 col-xxl-3">
            <div class="card card-body bg-primary bg-opacity-10 p-4 h-100">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <!-- Icon -->
                    <div
                        class="icon-lg rounded-circle bg-primary text-white mb-0">
        ...
        <div class="col-md-6 col-xxl-3">
            <div class="card card-body bg-success bg-opacity-10 p-4 h-100">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <!-- Icon -->
                    <div
                        class="icon-lg rounded-circle bg-success text-white mb-0">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="d-flex justify-content-between position-relative">
                        <div class="d-sm-flex">
                            ...
                            <div class="ms-0 ms-sm-2 mt-2 mt-sm-0">
                                <h6 class="mb-0">
                                    <a href="#" class="stretched-link">Lori Stevens</a>
                                </h6>
                                <p class="mb-0">
                    ...
                    <div class="d-flex justify-content-between position-relative">
                        <div class="d-sm-flex">
                            ...
                            <div class="avatar avatar-md flex-shrink-0">
                                <div
                                    class="avatar-img rounded-circle bg-purple bg-opacity-10">
                                    <span
                            ...
                            <div class="ms-0 ms-sm-2 mt-2 mt-sm-0">
                                <h6 class="mb-0">
                                    <a href="#" class="stretched-link">Dennis Barrett</a>
                                </h6>
                                <p class="mb-0">
                    ...
                    <div
                        ...
                        <div class="d-sm-flex align-items-center mb-1 mb-sm-0">
                            ...
                            <div class="ms-0 ms-sm-2 mt-2 mt-sm-0">
                                <h6 class="mb-1">
                                    Lori Stevens<i
                                        class="bi bi-patch-check-fill text-info small ms-1"></i>
                                </h6>
                                <ul class="list-inline mb-0 small">
                                    <li
                                        class="list-inline-item fw-light me-2 mb-1 mb-sm-0">
                        ...
                        <div class="d-sm-flex align-items-center mb-1 mb-sm-0">
                            ...
                            <div class="ms-0 ms-sm-2 mt-2 mt-sm-0">
                                ...
                                <ul class="list-inline mb-0 small">
                                    ...
                                    <li
                                        class="list-inline-item fw-light me-2 mb-1 mb-sm-0">
                                        <i class="fas fa-star text-warning me-1"></i>4.8/5.0
                                    </li>
                                </ul>
                            </div>
                        </div>
        ...
        <div class="col-lg-6 col-xxl-4">
            <div class="card shadow h-100">
                    ...
                    <div class="custom-scrollbar h-300px">
                        ...
                        <div
                            ...
                            <div class="d-sm-flex">
                                ...
                                <div class="ms-0 ms-sm-3 mt-2 mt-sm-0">
                                    <h6 class="mb-0">
                                        <a href="#" class="stretched-link">Join New Instructor</a>
                                    </h6>
                                    <p class="mb-0">
                        ...
                        <div
                            ...
                            <div class="d-sm-flex">
                                ...
                                <div class="ms-0 ms-sm-3 mt-2 mt-sm-0">
                                    <h6 class="mb-0">
                                        <a href="#" class="stretched-link">Update New Course</a>
                                    </h6>
                                    <p class="mb-0">
                        ...
                        <div
                            ...
                            <div class="d-sm-flex">
                                <div
                                    class="icon-lg bg-info bg-opacity-10 text-info rounded-2 flex-shrink-0">
                                    <i class="fas fa-book fs-5"></i>
                                </div>
                                <!-- Info -->
                                <div class="ms-0 ms-sm-3 mt-2 mt-sm-0">
                                    <h6 class="mb-0">
                                        <a href="#" class="stretched-link">Update Syllabus</a>
                                    </h6>
                                    <p class="mb-0">
                                        Arrived Fat weddings believed prospect
                                    </p>
                        ...
                        <div
                            ...
                            <div class="d-sm-flex">
                                ...
                                <div class="ms-0 ms-sm-3 mt-2 mt-sm-0">
                                    <h6 class="mb-0">
                                        <a href="#" class="stretched-link">Update New Feature</a>
                                    </h6>
                                    <p class="mb-0">
                                        Arrived Fat weddings believed prospect
                                    </p>
                ...
                <div class="card-footer border-top">
                    <div
                        class="alert alert-success d-flex align-items-center mb-0 py-2">
                        <div>
            ...
            <div class="card shadow h-100">
                ...
                <div class="card-body p-4">
                    ...
                    <ul class="list-group list-group-borderless mt-3">
                        ...
                        <li class="list-group-item">
                            <i class="text-warning fas fa-circle me-2"></i>Google Ads
                            Training: Become a PPC Expert
                        </li>
                        <li class="list-group-item">
