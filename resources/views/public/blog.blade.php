    ...
    <div class="container">
        <div class="row position-relative">
            ...
            <div class="col-lg-10 mx-auto text-center position-relative">
                ...
                <!-- SVG decoration -->
                <figure
                    class="position-absolute top-100 start-50 translate-middle mt-3 ms-n9 d-none d-lg-block">
                    <svg>
                        <path
                            class="fill-success"
...
<section class="position-relative pt-0 pt-lg-5">
    <div class="container">
        <div class="row g-4">
            ...
            <!-- Card item START -->
            <div class="col-sm-6 col-lg-4 col-xl-3 d-flex flex-column justify-content-between">
                <div class="card bg-transparent d-flex flex-column flex-grow-1 justify-content-between">
                    <div class="overflow-hidden rounded-3 " style="height: 200px;">
                        <img
                            src="{{ asset($post->image && file_exists(public_path($post->image))
        ? $post->image
        : 'assets/images/no-img.webp') }}"
                            class="card-img"
                            alt="course image" style="height: 100%;object-fit: cover;" />
                        <!-- Overlay -->
                        <div class="bg-overlay bg-dark opacity-4"></div>
                        <div class="card-img-overlay d-flex align-items-start align-content-start p-3 flex-wrap flex-row gap-1 justify-content-start">
                            <!-- badge -->
                    ...
                    <div class="card-body  d-flex flex-column flex-grow-1 justify-content-between">
                        ...
                        <div class="d-flex justify-content-between">
                            <h6 class="mb-0"><a href="#">{{ $post->author->name }}</a></h6>
                            <span class="small">{{ $post->smart_date }}</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- Pagination START -->
        {{ $posts->links('vendor.pagination.blog-pag') }}
        <!-- Pagination END -->
    </div>
</section>
<!-- =======================
